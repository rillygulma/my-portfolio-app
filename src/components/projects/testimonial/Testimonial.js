      ...
      <div className='w-full'>
        ...
        <div className='w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg
         shadow-shadowOne flex flex-col gap-8 justify-center'>
            ...
            />
            <div>
                <p className='text-sl uppercase text-designColor tracking-wide  mb-2'>
                    Bound - Trolola
                </p>
                <h3 className='text-2xl font-bold'>Rilly Gulma</h3>
            ...
            rounded-lg shadow-shadowOne p-8 flex flex-col justify-center gap-8'>
                <div className='flex justify-between items-center py-6 border-b-2 border-b-gray-900'>
                    <div>
                        ...
                        <p className='text-base text-gary-400 mt-3'>
                ...
                <p className='text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6'>
                 Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum v Lorem ipsum
                </p>
            </div>
        </div>
        </div>
